      ...
      <span className='w-[500px] h-[500px] bg-[#FFFFFF73] blur-[250px] rounded-full absolute top-[709px] left-[1067px]'></span>   
        <div className='flex justify-between'>
          <div className='flex flex-col gap-12 w-154.75 relative z-10'>
            <h2 className=' font-gabarito text-6xl w-154.75 flex flex-col gap-8 pt-8 text-[#111111]'>
              <b>
                Your Personal
              </b>
              <b className='text-[#FEFDFE]'>
                Mental Companion
              </b>
              <b>
                Is Always Here
            ...
            <p className=' text-[28px] text-[#FEFDFE]'>More than a chatbot — ONSY listens deeply, understands context, detects hidden emotions, and adapts its responses to what you truly need in the moment.</p>
          ...
          <div className='flex-col mt-88 w-146'>
            <div className='flex my-3'>
              <div className='bg-[#618475] w-16 h-16 rounded-4xl  flex justify-center items-center'><p className='text-5xl pb-1.5 text-white font-labrada'>ONSY</p></div>
            ...
            <div className=' justify-self-end-safe flex gap-10 my-3'>
              <div className='w-104  bg-white rounded-b-2xl rounded-l-2xl mt-8 p-3 text-[#111111]'>H onestly, I didn't sleep well and I'm anxious about my presentation</div>
            ...
            <div className=' justify-self-end-safe flex gap-10 my-3'>
              <div className='w-104 p-3 pl-6 bg-white rounded-b-2xl rounded-l-2xl mt-8 text-[#111111]'>Yes please, I could use that right now</div>
              <img src={icon} alt="Icon 1" className=" w-18 h-18 " />
            </div>
            <div className='flex my-3'>
              <div className='bg-[#618475] w-16 h-16 rounded-4xl  flex justify-center items-center'><p className='text-5xl pb-1.5 text-white font-labrada'>ONSY</p></div>
