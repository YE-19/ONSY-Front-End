      ...
      <div className='pt-40 px-40'>
        <div className="max-width-100 md:max-w-2/3 lg:max-w-1/2 mx-auto">
          ...
          >
            ...
            <div>
              <h1 className="text-[32px] font-bold mt-0 text-black"> Set a new password </h1>
              <p className='text-[#5F5F5F] font-semibold text-xl mb-2'>
            ...
            <div className='flex flex-col gap-2 px-19 font-semibold pb-10'>
              ...
              <Button 
                ...
                className={`bg-[#036464E5] h-14 w-96 mt-3 rounded-[10px] py-6 hover:shadow-[0_0_15px_3px_#FFFFFF80] hover:bg-[#264444e5] transition-all duration-300 ease-in-out text-white ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
              >           
